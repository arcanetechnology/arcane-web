...
function getAllProfileAccountOptions(profile: Profile): AccountOption[] {
...
function getAllStakeholderAccountOptions(account: Account): AccountOption[] {
...
function getAllPortfolioAccountOptions(portfolio: Portfolio): AccountOption[] {
...
export const fetchUserAccounts = createAsyncThunk<Array<AccountOption>, string>(
  'user/account',
