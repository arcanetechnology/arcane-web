...
declare global {
  ...
  const Title: typeof import('solid-meta')['Title']
  ...
  const createCookieStorage: typeof import('@solid-primitives/storage')['createCookieStorage']
  const createDeferred: typeof import('solid-js')['createDeferred']
  const createEffect: typeof import('solid-js')['createEffect']
  const createI18nContext: typeof import('@solid-primitives/i18n')['createI18nContext']
